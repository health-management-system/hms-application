...
describe("Tests for the view patient record panel", () => {
    ...
    it("Component fields labels can be initialized by passing props argument", () => {
        ...
        cy.get(':nth-child(2) > .view-record-span').should("have.text", record.PatientName);
        cy.get(':nth-child(3) > .view-record-span').should("have.text", record.clinic);
        cy.get(':nth-child(4) > .view-record-span').should("have.text", record.subject);
        cy.get(':nth-child(5) > .view-record-span').should("have.text", record.date);
